...
import {type ArticleDetails as ArticleMetadata} from "@/pages/post/data/article";
import {UrlType} from "@/pages/post/data/url";
...
export class MediumArticleProcessor {
    ...
    private stripHTML(html: string): string {
        ...
        const removeEmptyElements = (element: cheerio.Cheerio<any>) => {
    ...
    private extractTextContent(html: string): string {
        ...
        function processElement(element: cheerio.Cheerio<any>) {
        ...
        switch (type) {
            ...
            case "archive":
                ...
                const actionBar = sectionElement
                    ...
                    .first();
                sectionElementClone.find($(articleAuthorDetails.html() as any)).remove();
                sectionElementClone.find($(actionBar.html() as any)).remove();
