...
const features: FeatureProps[] = [
    {
        ...
        desc: "MediumWebID is free to use, no ads, no hidden subscriptions or service limits. Your mocks will be available forever",
        image: "https://wac-cdn-bfldr.atlassian.com/K3MHR9G8/at/mk553cskk88f65k68cbsk353/Icon-Checkmark.svg"
    },
    {
        title: "Developer Friendly",
        desc: "MediumWebID is compatible with JS, Mobile and Server applications, featuring CORS, JSONP and GZIP responses. No authentication, just call it!",
        image: "https://wac-cdn-bfldr.atlassian.com/K3MHR9G8/at/gb5s8vfb4rvbmpf8nncg2h/Icon-Certification.svg"
    },
    {
        title: "Total control",
        desc: "New in MediumWebID, you can now update or delete your mocks at any time. The next release will go further and offer you request inspector.",
