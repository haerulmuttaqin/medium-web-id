                ...
                <ContentWrapper>
                    ...
                    <Box>
                        ...
                        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree
                            ...
                            Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-Builder/" target="_blank" rel="noreferrer">Privacy
                                Policy Builder</a>.</p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to MediumWebID, accessible from <a
                                    href="https://medium.web.id" rel="external nofollow noopener noreferrer"
                                    target="_blank">https://medium.web.id</a></p>
                            </li>
                            <li>
