            ...
            >
                <ContentWrapper>
                    <Box xcss={xcss({paddingTop: "space.400", paddingBottom: "space.400"})}>
                        ...
                        <p>Streamline your development workflow! Our platform offers instant Resume  creation, real-time testing, and seamless integration</p>
                    </Box>
                    <Box>
                        <section id="our-story">
                            <h3>Our Story</h3>
                            <p>
                                MediumWebID was founded on the principle that API development shouldnt be complicated.
                        ...
                        <section id="features">
                            <h3>Key Features</h3>
                            <ul>
                                <li>Instant Mocking: Create Resume s in seconds</li>
